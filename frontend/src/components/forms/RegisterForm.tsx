...
import {State, Action, Errors} from "@/utils/types"
...
const useValidation = (formData: Errors) => {
...
const RegisterForm = () => {
	...
	const handleFormSubmit = async (e: React.FormEvent) => {
		...
		const signUpAPI = process.env.REACT_APP_REGISTER_API as string;
				...
				<div className="form-group">
					...
					<label>
						...
						{state.errors.confirmPass && (
							<span className="error-message">{state.errors.confirmPass}</span>
						)}
					</label>
